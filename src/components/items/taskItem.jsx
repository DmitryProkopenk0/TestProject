...
const [peoples, setPeoples] = useState([
    {name: 'Александа', value: '55', color: '#3A9EFF'},
    {name: 'Ангелина Сейт', value: '20', color: '#673AB7'},
    {name: 'Владимир ', value: '5', color: '#00BCD4'},
    {name: 'Денис', value: '10', color: '#10AB4F'},
    {name: 'Тимур', value: '10', color: '#FFB300'},
])
...
const [calendar_left, setCalendarLeft] = useState([
    {day_week: 'Пн', numbers: [
...
const [calendar_right, setCalendarRight] = useState([
    {day_week: 'Пн', numbers: [
        {number: 31, color: 'CFD8DC', background: 'white'}, 
        {number: 7,  color: '516173', background: 'white'}, 
...
const [openProfileContext, setOpenProfileContext] = useState(false)

const OpenContextProfile = () => {
    setOpenProfileContext(!openProfileContext)
}
    ...
    <div className='main__container'>
        <div className='head__content'>
            ...
            <div className='tasks__left'>
                <div className='distribution__tasks'>Распределение задач</div>
                <div className='some__tasks'>
                    <div className='tasks__text'>Задачи / </div>
                    <div className='time__context'>

                        <div className={openProfileContext === true ? 'time__selection__context' : 'false__time__selection__context'}>
                        ...
                        <div className='times__container'>
                            ...
                            <div className='tasks__time2' onClick={() => setHelpContext(true)}>15.01.22</div>
                        </div>
                ...
                <div className={moreContext === false ? 'more__false' : 'more__board'}>
                    <div className='items__board'>
                        <div className='item__board'>
                            <img src="/imgs/create.svg" alt="create" />
                            <div className='create__text'>Создать</div>
                        </div>
                        <div className='item__board'>
                            <img src="/imgs/edit-pen.svg" alt="edit" />
                    ...
                    <div className='tune__container'>
                        ...
                        <div className='tune__text'>Настроить</div>
                    </div>
